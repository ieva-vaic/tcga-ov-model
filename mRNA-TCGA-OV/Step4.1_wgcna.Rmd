...
data <- readRDS("C:/Users/Ieva/Desktop/NVI GDL/R projetcs/tcga-ov-data/train_count_matrix.RDS")
str(data)
pheno <- read.csv("C:/Users/Ieva/Desktop/NVI GDL/R projetcs/tcga-ov-data/train_data.csv", header = T)
