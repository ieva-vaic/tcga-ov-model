...
saveRDS(colData, "C:/Users/Ieva/Desktop/NVI GDL/R projetcs/tcga-ov-data/TCGA-OV-mRNA data/mRNA and clinical data TCGA-OV/coldata_wgna_mrna.RDS")
saveRDS(data.subset, "C:/Users/Ieva/Desktop/NVI GDL/R projetcs/tcga-ov-data/TCGA-OV-mRNA data/mRNA and clinical data TCGA-OV/outlier_data_subset_wgna_mrna.RDS")
```
...
norm.counts <- assay(dds_norm) %>% 
  t()
saveRDS(norm.counts, "norm.counts.wcgcna.mrna.RDS")
```
...
```{r}
bwnet <- readRDS("C:/Users/Ieva/Desktop/NVI GDL/R projetcs/tcga-ov-model/mRNA-TCGA-OV/bwnet.mRNA.TCGA-OV.RDS")
# 5. Module Eigengenes ---------------------------------------------------------
...
traits <- colData %>% 
  ...
  dplyr::select(49) #select the new colum, after the last one
