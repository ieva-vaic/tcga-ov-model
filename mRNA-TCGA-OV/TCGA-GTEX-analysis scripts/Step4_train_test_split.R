...
library(tidyverse)
gtcga_counts <- readRDS("mrna_voom.RDS")
...
saveRDS(gtex_counts_train, "train_gtcga_normcounts.RDS")
saveRDS(gtex_counts_test, "test_gtcga_normcounts.RDS")

saveRDS(gtex_cpheno_train, "train_gtcga_coldata.RDS")
saveRDS(gtex_pheno_test, "test_gtcga_coldata.RDS")